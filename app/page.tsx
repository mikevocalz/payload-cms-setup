    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-8 gap-8 bg-gradient-to-br from-violet-950 via-slate-900 to-slate-950">
      <div className="flex flex-col items-center gap-6 text-center max-w-2xl">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-5xl font-bold tracking-tight text-white">Counter Culture</h1>
        </div>
        <p className="text-xl text-slate-300">
          Express yourself. Connect authentically. Break the mold.
        </p>
        <p className="text-slate-400">
          A social platform for creators, thinkers, and those who dare to be different.
        </p>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl">
        <div className="text-center p-6 rounded-xl bg-slate-800/50 border border-slate-700">
          ...
          <p className="text-slate-400 text-sm">Engage in meaningful discussions with real-time messaging</p>
        </div>
        <div className="text-center p-6 rounded-xl bg-slate-800/50 border border-slate-700">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Creator Economy</h3>
          <p className="text-slate-400 text-sm">Support creators with subscriptions and exclusive content</p>
        </div>
        <div className="text-center p-6 rounded-xl bg-slate-800/50 border border-slate-700">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Events & Stories</h3>
          <p className="text-slate-400 text-sm">Share moments and organize events with your community</p>
        </div>
      </div>
    </div>
  )
